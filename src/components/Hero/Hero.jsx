        ...
        <div className="bg-primarybg pb-16 p-5 bg-bg-pattern bg-cover">
            ...
            <div className="w-full flex justify-between items-center">
                <div className="flex items-center gap-1">
                    ...
                    <h1 className='text-2xl font-semibold text-white'>BrainMate</h1>
                </div>
                <div className="flex items-stretch gap-5">
                    ...
                    <div onClick={() => { window.location.href = 'https://brainmate.vercel.app/signup' }} className="bg-primary text-white py-2 px-4 rounded-lg cursor-pointer">Login</div>
                </div>
            </div>

            {/* hero */}
            <div className="py-20">
                <div className="flex gap-5 flex-col justify-center items-center h-[40vh]">
                    <h1 className='text-6xl font-semibold text-white'>Get More Done with BRAINMATE</h1>
